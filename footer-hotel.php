...
$hotel_color       = function_exists( 'vbl_get_hotel_accent_color' ) ? vbl_get_hotel_accent_color( $current_hotel_id ) : '#00B5B4';
...
?>
  ...
  <style>
    .vbl-footer-hotel-link {
      transition: color 0.3s ease, text-decoration-color 0.3s ease;
    }
    .vbl-footer-hotel-link:hover {
      color: <?php echo esc_attr( $hotel_color ); ?> !important;
      text-decoration-color: <?php echo esc_attr( $hotel_color ); ?> !important;
    }
    .vbl-footer-social {
      transition: color 0.3s ease, transform 0.2s ease;
    }
    .vbl-footer-social:hover {
      color: <?php echo esc_attr( $hotel_color ); ?> !important;
    }
  </style>
  ...
  <footer class="w-full bg-white font-body pt-16 lg:pt-24 pb-8">
    <div class="max-w-[1920px] mx-auto px-6 xl:px-[8.33%]">
      ...
      <div class="flex flex-col lg:flex-row lg:justify-between items-start gap-12 lg:gap-8 mb-16 xl:mb-24">
        ...
        <div class="flex flex-col gap-6">
          ...
          <div class="flex items-center gap-5 text-[#0d5257]">
            ...
            <a href="<?php echo esc_url( $instagram ); ?>" target="_blank" rel="noopener" class="vbl-footer-social">
            ...
            <a href="<?php echo esc_url( $youtube ); ?>" target="_blank" rel="noopener" class="vbl-footer-social">
              <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div class="flex flex-col gap-6">
          ...
          <a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="Vila Baleira Hotels" class="flex items-center gap-4 lg:gap-5 flex-shrink-0 hover:opacity-80 transition-opacity">
            ...
            <div class="flex flex-col gap-1 lg:gap-1.5">
              <img src="<?php echo vbl_img('footer-logo-text.svg'); ?>" alt="Vila Baleira" class="h-[10px] lg:h-[12px] w-auto">
      ...
      <!-- Bottom bar -->
      <div class="flex flex-col xl:flex-row items-start xl:items-center justify-between border-t border-[#0da9a6]/20 pt-6 gap-6 relative">
        <div class="flex flex-wrap items-center gap-3 lg:gap-4 text-[9px] uppercase tracking-wider text-black/60 font-medium">
          ...
          ?>
              <a href="<?php echo esc_url( $resolved_url ); ?>"<?php echo $target; ?> class="vbl-footer-hotel-link hover:underline hover:underline-offset-4 decoration-1 transition-all"><span class="whitespace-nowrap"><?php echo esc_html( $llink['label'] ); ?></span></a><span class="text-[#0da9a6] hidden lg:inline">|</span>
          <?php else : ?>
        ...
        <div class="text-[9px] uppercase tracking-wider text-black/60 font-medium whitespace-nowrap">
          VILA BALEIRA &copy; <?php echo date( 'Y' ); ?> <span class="mx-2 text-[#0da9a6]">|</span> <a href="https://www.sanzza.com" target="_blank" class="vbl-footer-hotel-link hover:underline hover:underline-offset-[3px] decoration-1 transition-all">DESIGNED BY SANZZA</a>
        </div>
      </div>
    </div>
  </footer>
